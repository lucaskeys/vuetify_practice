<template>
  <v-app id="inspire">
    <v-navigation-drawer v-model="drawer" app>
      <v-list-item>
        <v-list-item-content>
          ...
          <v-list-item-subtitle> Vue </v-list-item-subtitle>
        </v-list-item-content>
      </v-list-item>
    ...
    <v-app-bar prominent app color="primary" dark src="lake.jpeg">
...
export default {
  data() {
    return {
      drawer: null,
      items: [
        // mdi icon names are taken from vuetify doc - material icons
